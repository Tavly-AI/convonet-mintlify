...
description: "Set one language on a Tavly agent to control speech recognition, voice pronunciation, and the language the agent responds in throughout each call."
---
