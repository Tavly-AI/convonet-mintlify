---
title : Guardrails
description: "Configure Tavly guardrails to detect prohibited topics in agent responses and user input, replacing flagged content with a safe placeholder mid-call."
---
> Use Tavly guardrails to detect prohibited topics in agent responses and user input, replacing flagged content with a safe placeholder so calls continue.
