...
<AccordionGroup>
  <Accordion title="Which DTMF format does Tavly capture?">
    Tavly captures RFC 2833 DTMF (keypad tones sent as RTP events) by default. If digits aren't being recognized, you can confirm how they were sent by [analyzing the call's PCAP file](/reliability/debug-calls-pcap#extract-and-inspect-dtmf-events) in Wireshark.
  </Accordion>
