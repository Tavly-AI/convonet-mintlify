...
description: "Reference table of which Tavly text-to-speech and speech recognition providers support each language, with API language codes and model-level notes."
---
