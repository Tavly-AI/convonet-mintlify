...
description: "Inject per-call data into Tavly agent prompts, tools, webhooks, and voicemail using {{variable_name}} placeholders for personalized greetings and routing."
---
