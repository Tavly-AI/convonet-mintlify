...
description: "Attach URLs, documents, and text to a Tavly agent knowledge base, then tune retrieval with a query-rewrite instruction for accurate mid-call answers."
---
