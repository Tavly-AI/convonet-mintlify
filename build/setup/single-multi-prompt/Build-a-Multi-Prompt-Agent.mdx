...
description: "Build a Tavly multi-prompt agent by breaking a conversation into prompted states with explicit transitions between them, like lead qualification."
---


> Build a Tavly multi-prompt agent by breaking the conversation into prompted states with explicit transitions between them — like a lead qualification flow.
