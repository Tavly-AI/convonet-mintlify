...
| Collect structured data only for after the call (analytics, webhook) | [Post Call Extraction](/features/post-call-analysis-overview)                                 |
...
<AccordionGroup>
  ...
  <Accordion title="Is this the same as Post Call Extraction variables?">
    ...
    later turns. [Post Call Extraction](/features/post-call-analysis-overview) extracts data
