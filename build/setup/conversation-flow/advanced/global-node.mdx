---
title: Global node
description: "Enable global nodes in a Tavly conversation flow to jump from any node when a condition matches, ideal for callbacks and human handoff intents."
---
