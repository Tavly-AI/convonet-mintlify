...
description: "Use a Tavly conversation node for multi-turn dialogue without tool calls, with Prompt or Static Sentence instructions and transition conditions."
---
