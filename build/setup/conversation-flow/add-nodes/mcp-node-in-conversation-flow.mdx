...
description: "Add an MCP node to a Tavly conversation flow to call remote MCP server tools mid-call, with custom request headers, query parameters, and auth."
---
