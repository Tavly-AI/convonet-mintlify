...
> Add an extract dynamic variable node to a Tavly conversation flow to pull values from the dialogue and store them as text, number, boolean, or enum variables.
