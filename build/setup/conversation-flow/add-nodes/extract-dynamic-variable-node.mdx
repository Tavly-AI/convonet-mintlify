...
description: "Add an extract dynamic variable node to a Tavly conversation flow to capture values from dialogue as Text, Number, Enum, or Boolean variables."
---
