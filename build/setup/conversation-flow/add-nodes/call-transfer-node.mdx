...
description: "Add a call transfer node to a Tavly conversation flow to hand a phone call to another number or SIP URI, with cold, warm, and agentic warm transfer."
---
