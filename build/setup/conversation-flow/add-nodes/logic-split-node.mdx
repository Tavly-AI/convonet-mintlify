...
description: "Add a logic split node to a Tavly conversation flow to branch on conditions or dynamic variables silently on entry, with an else fallback destination."
---
