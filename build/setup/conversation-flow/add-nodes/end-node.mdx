---
title: End node
description: "Add end nodes to a Tavly conversation flow to terminate the call, optionally with a closing message generated from a prompt or static sentence."
---
