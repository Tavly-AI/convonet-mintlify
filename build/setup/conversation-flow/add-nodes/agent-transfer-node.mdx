...
description: "Use an agent transfer node to hand a Tavly call from one AI agent to another with low latency, no new phone call, and full conversation history."
---
