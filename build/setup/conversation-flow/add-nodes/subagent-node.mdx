---
title: 'Subagent Node'
description: "Use a subagent node in a Tavly conversation flow to combine dialogue with on-the-fly tool calls, letting the LLM decide when to invoke each tool."
---
...
| Transfer Agent           | Transfer to another Tavly agent                              | [Transfer Agent](/build/single-multi-prompt/transfer-agent)       |
