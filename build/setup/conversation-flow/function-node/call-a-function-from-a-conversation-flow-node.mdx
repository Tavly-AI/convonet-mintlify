...
description: "Call a pre-built function, integration tool, or custom function from a Tavly conversation flow function node; fires on entry and transitions on the result."
---
