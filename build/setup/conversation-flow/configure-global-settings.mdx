...
<Steps>
  <Step title="Configure Voice Settings">
    ...
    **Custom Voices**: You can also add voices from the ElevenLabs community or clone voices by clicking "Add custom voice". Learn more in our [voice configuration guide](/build/speech/voice).
  ...
  <Step title="Select Language of Agent">
    ...
    To support multiple languages, switch the selector to **Multiselect** and pick the specific languages you want; for best accuracy, prefer a single language when possible. See [Set language for your agent](/build/language) and [Configure a multilingual agent](/build/multilingual) for details.
  </Step>
  ...
  <Step title="Configure Knowledge Base">
    Here's where you can supply contexts to the agent via documents, URLs, or texts. Read more at [Knowledge Base Guide](/build/context/knowledge-base).
  </Step>
  ...
  <Step title="Configure Call Settings">
    ...
    * Voicemail related settings: set up voicemail detection and what to do when voicemail is detected. See more at [Handle Voicemail](/build/telephony/handle-voicemail).
  ...
  <Step title="Configure Post Call Extraction">
    Probably set up later; read more at Post Call Extraction Guide {/* broken-link: /features/post-call-analysis-overview target page does not exist in this repo */}.
  </Step>
