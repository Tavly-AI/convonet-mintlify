...
<Warning>
  ...
  token scaling billing rule {/* broken-link: /accounts/billing-exceptions#rule-2-llm-price-scaling-for--4000-token-prompt-length target page does not exist in this repo */}
