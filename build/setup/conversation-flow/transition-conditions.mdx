...
description: "Control when a Tavly conversation flow moves between nodes: prompt conditions evaluated by the LLM, deterministic equation conditions, and else edges."
---
