...
description: "Tune Tavly LLM settings including temperature, structured output, fast tier, retries, and timeouts to balance reliability, latency, and cost per agent."
---
> Tune Tavly LLM settings — temperature, fast tier, structured output, retries, timeouts — to balance reliability, latency, and cost for your voice agent.
