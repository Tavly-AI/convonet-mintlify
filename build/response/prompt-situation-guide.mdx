...
description: "Prompt examples for common Tavly voice agent situations including phone numbers, emails, dates, spellings, and confirmations, many available as presets."
---
