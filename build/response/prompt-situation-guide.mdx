---
title : Prompt guide & examples for specific situations
---
...
<Tip>Many of these patterns — including phone number pronunciation, email spelling, and speech normalization — are now available as one-click presets in the [Agent Handbook](/build/response/agent-handbook).</Tip>
