...
description: "Run pre-call and post-call functions on Tavly voice and chat agents to look up callers before the greeting and log outcomes after the session ends."
---
