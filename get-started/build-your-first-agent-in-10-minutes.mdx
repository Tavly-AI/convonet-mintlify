...
> Build your first Tavly AI phone agent in 10 minutes: create an account, pick a template, test in the dashboard, deploy to a phone number, and make a call.

**Tavly** is a platform for building, testing, and deploying **AI phone agents** that hold natural conversations over the phone.

<Steps>
  <Step title="Create your account">
    1. Visit the [Tavly Dashboard](https://www.tavly.it/)
  ...
  <Step title="Create a new agent">
    ...
    4. Choose how to start: click **Build from scratch** to build everything yourself, pick a ready-made template like Receptionist or Insurance Verification Caller, or click **Generate from prompt** (marked Suggested) to let Conductor {/* broken-link: /conductor/create-agent target page does not exist in this repo */} draft an agent from a plain-English description of your use case
  ...
  <Step title="Deploy to a phone number">
    ...
    Tavly-managed numbers are US and Canada only: \$2 per month for normal phone numbers, \$5 per month for toll-free phone numbers. If you need a number from another country or want to bring your own telephony provider, see custom telephony {/* broken-link: /deploy/custom-telephony target page does not exist in this repo */} instead.
...
<AccordionGroup>
  ...
  <Accordion title="Do I need a phone number to try Tavly?">
  ...
  <Accordion title="Can I get a number outside the US or Canada?">
    Not as a Tavly-managed number. Connect your own provider instead. See custom telephony {/* broken-link: /deploy/custom-telephony target page does not exist in this repo */}.
  </Accordion>

  <Accordion title="My payment method was declined. What now?">
    Double-check the card details and try again, or add a different payment method from the "Billing" tab. See add payment methods {/* broken-link: /accounts/add-payment target page does not exist in this repo */} for more detail.
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  <Card title="Customize Your Agent" icon="sparkles" href="/build/build-a-tavly-ai-agent-overview">
    See everything you can configure, prompts, voice, knowledge, and more
  </Card>

  <Card title="Add Functions" icon="code" href="/build/setup/single-multi-prompt/Function-Calling-Overview">
  ...
  {/* broken-link: href /features/post-call-analysis-create removed; target page does not exist in this repo */}
  <Card title="Set Up Post Call Extraction" icon="clipboard-check">
