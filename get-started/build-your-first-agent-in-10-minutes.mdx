...
<Steps>
  ...
  <Step title="Deploy to a phone number">
    ...
    Tavly-managed numbers are US and Canada only: \$2 per month for normal phone numbers, \$5 per month for toll-free phone numbers. If you need a number from another country or want to bring your own telephony provider, see [custom telephony](/deploy/custom-telephony) instead.
...
<AccordionGroup>
  ...
  <Accordion title="Can I get a number outside the US or Canada?">
    Not as a Tavly-managed number. Connect your own provider instead. See [custom telephony](/deploy/custom-telephony).
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Set Up Post Call Extraction" icon="clipboard-check" href="/features/post-call-analysis-create">
