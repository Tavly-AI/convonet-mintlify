...
category: Data
title:  Contacts
description: "Manage the people your Tavly agents call and text: contact records keyed by phone number, custom contact fields, post-call data mappings, and CRM sync."
---
